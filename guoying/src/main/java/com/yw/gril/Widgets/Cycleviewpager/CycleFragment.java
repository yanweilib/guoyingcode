package com.example.androidcode.Widgets.Cycleviewpager;
...
import com.example.androidcode.Model.ADInfo;
...
public class CycleFragment extends Fragment implements OnPageChangeListener {
	...
	private TextView tv_carousel_text;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		tv_carousel_text= (TextView) view.findViewById(R.id.tv_carousel_text);
	...
	private void setIndicator(int selectedPosition) {
		...
		if (indicators.length > selectedPosition)
		{
			...
			tv_carousel_text.setText(infos.get(selectedPosition).getContent());
		}
	}
